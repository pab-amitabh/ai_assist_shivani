...
export async function POST(req: Request) {
    ...
    try {
        ...
        // If the answer isn't in the context, say "Sorry for the inconvinience. Please try again....", don't try to make up an answer, however please provide a short explanation on where they may be able to find the answer. 
        ...
        If the answer isn't in the context, say "Sorry for the inconvinience. Please try again....", don't try to make up an answer. Add as many emojis as you can inside the response  to make it look more attractive and presentable.
...
// Helpful Answer:`;
        ...
        console.log('check answer::',resAnswer)
        if (resAnswer.includes("Sorry for the inconvenience. Please try again....")) { 
            ...
            const contextualizedQuery = await contextualizeQChain.invoke({
                ...
                const transformStream = new TransformStream({
                    async transform(chunk, controller) {
                        if (chunk.answer) {
                            // console.log('getting value::',chunk.answer)
                    ...
                    flush(controller){
                        if (responseString.includes("Sorry for the inconvenience. Please try again...")){
                            console.log('show the first response...')
                        }
                    }
                });
