...
export async function POST(req: Request) {
    ...
    try {
        ...
        // If the answer isn't in the context, say "garbagevalue", don't try to make up an answer, however please provide a short explanation on where they may be able to find the answer. 
        ...
        Use the following pieces of context to answer the question at the end in detail specifically mentioning about insurance. Also don't repeat yourself & don't give summary. Always try to bring the most latest & most accurate information out of the documents, and give the response in form of table wherever suitable.
        If the answer isn't in the context, only return "garbagevalue", don't try to make up an answer. I repeat just return "garbagevalue" if answer isn't avaiable in the context. Add as many emojis as you can inside the response  to make it look more attractive and presentable.
...
// Helpful Answer:`;
        ...
        if (resAnswer.includes("garbagevalue")) { 
            ...
            //     let responseString = "garbagevalue";
            //     let isInitalResponse=false;
