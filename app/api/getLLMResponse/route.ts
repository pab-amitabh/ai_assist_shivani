...
export async function POST(req: Request) {
    ...
    try {
        ...
        If the answer isn't in the context, say "garbagevalue", don't try to make up an answer. Add as many emojis as you can inside the response  to make it look more attractive and presentable.
