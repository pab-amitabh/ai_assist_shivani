...
export default function CommandActivation() {
    ...
    useEffect(() => {
        if (travelMode === true) {
            ...
            setModelType('chatbot')
        }
    }, [travelMode, modelType])
    ...
    const [currentChat, setCurrentChat] = useState<{
        ...
        rating: number;
        reviewComments: string;
        modelType: string;     // <<< Add modelType here too
        commentAddedAt?: Date | null;
        createdAt?: Date | null;
    }[]>([{
        ...
        rating: -1,
        reviewComments: "",
        modelType: modelType,     // <<< Default value
        commentAddedAt: null,
        createdAt: null
    }]);
    ...
    const changeTravelMode = (isChecked: boolean) => {
        setTravelMode(isChecked);

        if (isChecked) {
            setActiveButton("Travel Insurance");
        }
    };
