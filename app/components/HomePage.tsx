...
const HomePage = () => {
    ...
    return (
        // <div className="flex items-center justify-center h-screen bg-cover bg-center" style={{ backgroundImage: "url('/homepage_background1.png')" }}>
        ...
        <div className="relative w-screen h-screen overflow-hidden">
            <img src="/homepage_background1.png" className="absolute top-0 left-0 w-full h-full object-cover" alt="Background"/>
            <button onClick={() => signIn()} className="transition-transform duration-300  hover:translate-x-2 flex absolute bottom-36 ml-16 focus:outline-none justify-center items-center text-white bg-[rgb(216,22,113)] hover:bg-[rgb(216,22,113)]-700  font-medium text-md px-7 py-4 me-2 mb-2">Sign In 
